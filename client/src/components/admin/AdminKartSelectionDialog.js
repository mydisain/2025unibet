...
const AdminKartSelectionDialog = ({
  open,
  onClose,
  onConfirm,
  timeslot,
  ...
  return (
    ...
    >
      <DialogTitle>
        {t('admin_select_karts_for_timeslot', { timeslot: `${timeslot.startTime} - ${timeslot.endTime}` })}
      </DialogTitle>
      <DialogContent>
        {kartsLoading ? (
          ...
          <>
            <DialogContentText>
              {t('admin_kart_selection_description')}
            </DialogContentText>
...
export default AdminKartSelectionDialog;
